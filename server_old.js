...
var isUseHTTPs = getCurrentConfigSetting("isUseHTTPs");
var port = getCurrentConfigSetting("serverPort");
var autoRebootServerOnFailure = getCurrentConfigSetting("autoRebootServerOnFailure");
...
function getCurrentConfigSetting(key) {
